...
public class UserController {
    ...
    /**
     * Constructor that created a default admin if one doesn't existes.
     * @param userService user service for the controller.
     * @param friendListRepository friendlist repository for user.
     */
    @Autowired
    ...
    /**
     * Get the group of a user by email.
     * @param email of a given user's group to get.
     * @return List of group user is in.
     */
    ...
    /**
     * Login as a user.
     * @param strRequest JSON info of a user.
     * @return User info with login token for future api interactions.
     * @throws JSONException exception if json cannot generate.
     * @throws IllegalAccessException login is incorrect and created problems.
     */
     ...
     * @param strRequest JSON of the User trying to promote.
     * @return success if successfully promote the user.
