...
public class RecommendationController {
     ...
     * @param request JSON with info to create recommendation.
     * @return success if successfully created a recommendation.
     * @throws JSONException if fail to generate json.
     */
     ...
     * @param request JSON with recommendation to delete.
    ...
    /**
     * Get recommendation
     * @param request JSON with recommendation to get.
     * @return Info about a recommendation.
     * @throws JSONException if json fail to generate.
     */
    @RequestMapping("/get")
    ...
    /**
     * Helper to abstract out the common request and response.
     */
